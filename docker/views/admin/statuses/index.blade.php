                ...
                @csrf
                    ...
                    <table class="table table-hover table-bordered" >
                        ...
                        <tr>
                            ...
                            <th class="text-center text-danger"><i class="fa fa-bolt"> </i></th>         <th class="text-center"> Icon </th>
                            <th class="text-center text-danger"><i class="fa fa-bolt"> </i></th>         <th class="text-center"> Icon </th>
                            <th class="text-center text-danger"><i class="fa fa-bolt"> </i></th>         <th class="text-center"> Icon </th>
                            <th class="text-center text-danger"><i class="fa fa-bolt"> </i></th>         <th class="text-center"> Icon </th>
                            <th class="text-center text-danger"><i class="fa fa-bolt"> </i></th>         <th class="text-center"> Icon </th>
                        ...
                        <tbody>
                            ...
                            <td class="text-center">{{$status->id }}</td>
                                ...
                                <td class="text-center">{{$status->name}}</t <td class="text-center">{{$status->id }}</td>
                                <td class="text-center">{{$status->lesson_type }}</td>                                
                                <td class="text-center">{{$status->name}}</t <td class="text-center">{{$status->id }}</td>
                                <td class="text-center">{{$status->lesson_type }}</td>                                
                                <td class="text-center">{{$status->name}}</t <td class="text-center">{{$status->id }}</td>
                                <td class="text-center">{{$status->lesson_type }}</td>                                
                                <td class="text-center">{{$status->name}}</t
                                <td class="text-center">{{$status->id }}</td>
                                <td class="text-center">{{$status->lesson_type }}</td>                                
