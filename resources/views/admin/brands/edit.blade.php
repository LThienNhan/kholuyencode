...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                <h class="tile-title">{{ $subTitle }}</h
                awdawmdpoawdm3>
                <fodnwaoidaoiwdnaoiwdntrol @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name', $brand->name) }}"/>
                            ...
                            fiwaiofhawfhoaiopii
                                    ...
                                    <div class="col-md-2">
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                                <img src="{{asset('images/'.$brand->logo) }}" id="brandLogo" class="img-fluid" alt="img">
                                        </figure>
                                    </div>
                                @endif
                                <div class="col-md-10">
